const Notification = () => {
  return (
    <div className="2xl:w-4/12 mt-2 bg-gray-50 h-screen overflow-y-auto p-2 ">
      <div className="flex items-center justify-between p-2">
        <p className="focus:outline-none text-xl font-semibold leading-6 text-gray-800">
          Notifications
        </p>
        <button
      ...
      <div className="flex flex-col">
        <div className="w-full flex items-center justify-center p-3 mt-4 bg-white rounded ">
          <div
          ...
          <div className="pl-3">
            ...
            <p className="focus:outline-none text-xs text-left leading-3 pt-1 text-gray-500">
              2 hours ago
            </p>
          </div>
        </div>
